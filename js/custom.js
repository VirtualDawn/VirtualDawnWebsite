...
// Parallax
	...
	function parallaxInit() {
		...
		$('#video_parallax').parallax("80%", 0.1);
		$('#featured_parallax').parallax("30%", 0.1);
	}
	
// Skills + Gets the skils section bar color
	$('.chart').easyPieChart({
		...
		var map = new google.maps.Map(document.getElementById('map'), {
		  ...
		  zoom: 10,
			...
			styles: [ { "stylers": [ { "hue": "#27e0ff" },  {saturation: 100},
                {gamma: 1} ] } ],
			center: new google.maps.LatLng(61.6500008, 22.8144018),
